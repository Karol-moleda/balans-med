...
export class DoctorsComponent implements OnInit {
  doctors: Doctor[] = [
    ...
    },
    {
      ...
      image: ''  // Empty image path to trigger our placeholder
    },
        {
      id: 5,
  ...
  onImageError(event: any) {
    ...
    // If the source is already a placeholder, don't modify it
    if (imgSrc.includes('placehold.co')) {
      return;
    }
    
    // For other images, create a placeholder with the doctor name
