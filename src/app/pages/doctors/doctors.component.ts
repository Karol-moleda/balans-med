...
export class DoctorsComponent implements OnInit {
  doctors: Doctor[] = [
    ...
    },
    {
      ...
      description:
        'Jestem lekarzem, absolwentką Uniwersytetu Medycznego w Łodzi. Obecnie odbywam specjalizację z psychiatrii w Szpitalu Klinicznym im. dr. Józefa Babińskiego w Krakowie. Stale poszerzam swoją wiedzę i umiejętności, uczestnicząc w kursach, konferencjach oraz śledząc najnowsze piśmiennictwo z zakresu psychiatrii. Oferuję konsultacje psychiatryczne dla osób dorosłych. W pracy z pacjentem szczególnie zależy mi na stworzeniu bezpiecznej i pełnej zaufania przestrzeni, opartej na szacunku i zrozumieniu. Dzięki temu możliwe jest trafne dobranie indywidualnego planu leczenia farmakologicznego, a w razie potrzeby – również wskazanie odpowiedniego nurtu psychoterapii.',
    ...
    },
    {
      ...
      description:
        'Jestem psychologiem i psychoterapeutką w trakcie całościowego szkolenia w nurcie psychodynamicznym w Krakowskim Centrum Psychodynamicznym (KCP). Ukończyłam psychologię na Uniwersytecie Pedagogicznym w Krakowie. Doświadczenie zawodowe zdobywałam, pracując w liceum i przedszkolu, gdzie prowadziłam konsultacje dla dzieci, młodzieży i rodziców. W pracy stawiam na spokojną rozmowę, uważność i małe kroki. Pierwsze spotkanie to poznanie sytuacji i wspólne ustalenie celów. Ważne są dla mnie jasność, konsekwencja i dostosowanie tempa do możliwości klienta. Z dorosłymi pracuję m.in. nad stresem, przeciążeniem, lękiem, obniżonym nastrojem, trudnościami w relacjach i zmianami życiowymi. Z dziećmi i młodzieżą zajmuję się regulacją emocji, zachowaniami, relacjami rówieśniczymi oraz rozwojem komunikacji. Pracuję z dziećmi od 3. roku życia. </br> Pomagam m.in. w: ● napadach złości, lęku i trudnościach z koncentracją, ● adaptacji w grupie i relacjach z rówieśnikami, ● opóźnieniach mowy i mutyzmie wybiórczym, ● trudnościach neurorozwojowych (ADHD, spektrum autyzmu). W obszarze spektrum autyzmu wykonuję przesiew i wstępną ocenę funkcjonowania. Pomagam w planowaniu małych, realnych kroków — wspierających komunikację, przewidywalność dnia i samoregulację. W czym mogę pomóc: ● Regulacja emocji i zachowań ● Trudności w relacjach i adaptacji ● Wsparcie komunikacji i rozwoju mowy ● ADHD i spektrum autyzmu ● Nawyki dnia codziennego (sen, jedzenie, trening czystości) ● Higiena cyfrowa',
      image: 'img/Milena.jpg',
    },
    {
      id: 8,
      name: 'mgr. Karolina Makuchowska',
      description:
        'Jestem psychologiem oraz psychoterapeutą w trakcie całościowego szkolenia psychoterapeutycznego w nurcie poznawczo-behawioralnym (CBT) w Centrum CBT rekomendowanym przez Polskie Towarzystwo Psychoterapii Poznawczo-Behawioralnej. Ukończyłam jednolite studia magisterskie z psychologii na Uniwersytecie Jagiellońskim.Oferuję konsultacje psychologiczne dla dzieci od 10. roku życia, młodzieży oraz osób dorosłych. Wspieram osoby doświadczające m.in.:• depresji i obniżonego nastroju,• zaburzeń lękowych i fobii,• przewlekłego stresu i napięcia,• niskiego poczucia własnej wartości,• trudności emocjonalnych i relacyjnych,• problemów w szkole, pracy lub codziennym funkcjonowaniu. W pracy najważniejsza jest dla mnie autentyczna relacja, poczucie bezpieczeństwa i indywidualne podejście do każdej osoby. Pomagam lepiej zrozumieć własne emocje, schematy działania oraz wypracować skuteczne strategie radzenia sobie z codziennymi wyzwaniami.Regularnie rozwijam swoje kompetencje i pracuję zgodnie z aktualną wiedzą psychologiczną oraz zasadami etyki zawodowej, aby zapewnić profesjonalne i skuteczne wsparcie. ',
      image: 'img/MagdalenaMroz.jpg',
    },
    {
      id: 9,
      name: 'mgr. Magdalena Mróz',
      description:
        'Jestem psycholożką, seksuolożką i terapeutką pracującą w nurcie poznawczo-behawioralnym (CBT), w trakcie całościowego 4-letniego szkolenia w Szkole Psychoterapii Poznawczo-Behawioralnej Uniwersytetu SWPS w Krakowie. Ukończyłam 5-letnie studia magisterskie z psychologii na Uniwersytecie Jagiellońskim, specjalność psychoterapia, oraz 2-letnie studia podyplomowe z seksuologii klinicznej na Uniwersytecie SWPS.Doświadczenie kliniczne zdobywałam zarówno w pracy na zamkniętym oddziale psychiatrycznym, jak i na oddziale dziennym Szpitala Klinicznego im. dr. Józefa Babińskiego w Krakowie, gdzie zajmowałam się psychoterapią grupową, diagnozą psychologiczną, wsparciem oraz psychoedukacją osób z różnorodnymi trudnościami psychicznymi. Uzupełnieniem tej ścieżki były staże kliniczne z zakresu seksuologii. Obecnie pracuję jako seksuolożka, prowadząc procesy diagnostyczne i terapeutyczne.W pracy terapeutycznej towarzyszę osobom dorosłym doświadczającym trudności emocjonalnych, zaburzeń nastroju, zaburzeń lękowych, przewlekłego stresu oraz kryzysów psychicznych. Wspieram również osoby mierzące się z niską samooceną, perfekcjonizmem, dysregulacją emocjonalną oraz trudnościami w relacjach interpersonalnych. W podejściu CBT koncentruję się na zrozumieniu mechanizmów podtrzymujących obecne trudności oraz pracy nad zmianą nieadaptacyjnych wzorców myślenia i zachowania w oparciu o metody o potwierdzonej skuteczności, ukierunkowane na trwałą poprawę funkcjonowania.Swoją praktykę opieram na aktualnej wiedzy naukowej, nieustannie poszerzając kompetencje poprzez udział w szkoleniach, konferencjach oraz pracę z literaturą specjalistyczną. Jestem członkinią Polskiego Towarzystwa Terapii Poznawczej i Behawioralnej, a swoją pracę regularnie poddaję superwizji, dbając o jej wysoką jakość oraz zgodność z zasadami etyki zawodowej.W relacji terapeutycznej szczególne znaczenie ma dla mnie tworzenie bezpiecznej, opartej na zaufaniu i szacunku przestrzeni, sprzyjającej uważnemu przyglądaniu się własnym doświadczeniom i potrzebom. W obszarze seksuologii pracuję w podejściu sekspozytywnym, oferując wsparcie osobom doświadczającym trudności w zakresie życia seksualnego, relacji oraz tożsamości. Pracuję z osobami o różnorodnych tożsamościach płciowych, seksualnych i relacyjnych, z pełną otwartością i poszanowaniem ich indywidualnych doświadczeń.',
      image: 'img/KarolinaMakuchowska.png',
    },
  ];
  ...
  ngOnInit() {
    this.doctors.forEach((doctor) => {
      ...
      doctor.formattedDescription = this.formatDescription(
        doctor.description,
        false,
      );
    });
  ...
  private formatFullDescription(description: string): string {
    let formatted = description
      ...
      .replace(/(<li>[^<]*?\.)\s+([A-ZĄĆĘŁŃÓŚŹŻ])/g, '$1</li></ul><p>$2')
